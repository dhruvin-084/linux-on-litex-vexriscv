...
git_repos = {
    ...
    "litex":                           GitRepo(url="https://github.com/dhruvin-084/", tag=True),
    ...
    "litespi":      GitRepo(url="https://github.com/dhruvin-084/",   tag=True),
